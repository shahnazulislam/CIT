    ...
    <form action="" method="POST" enctype="multipart/form-data">
      <div class="form-group">
        ...
        <div class="input-group input-group-merge">
          <input id="email_2" name="email" type="email" class="form-control form-control-prepended" placeholder="john@doe.com">
      ...
      <div class="form-group text-center">
        <button class="btn btn-primary mb-2" name="submit" type="submit">Sign in</button><br>
        <a class="text-body text-underline" href="tatistration.php">Have't any account? Sign Up</a>
      </div>
    </form>
  </div>
